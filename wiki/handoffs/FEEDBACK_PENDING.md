...
| 40 | S7 smoke test: primer-touch claimed via `git add` w/o a real diff; gate correctly saw "not touched", but net effect matched a missed boundary | p1 | open | Full repro: `rule-archive.md` "Round 28". Q: does the elective-arm threshold already cover this? | round 28 |
